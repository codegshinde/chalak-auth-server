...
const _registerSchema = require("../schema/registerSchema");
/**
 ...
 */ async function registerHandler(request, response) {
    ...
    try {
        ...
        data.adminId = await request.createUniqId(data.firstName, data.lastName);
        const admin = await request.createDocument(data);
